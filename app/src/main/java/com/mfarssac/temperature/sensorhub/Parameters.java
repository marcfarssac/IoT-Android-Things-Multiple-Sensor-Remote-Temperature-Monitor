...
public class Parameters {
    ...
    public Parameters( String projectId, String registryId, String cloudRegion, String deviceId, String keyAlgorithm) {
    ...
    public static Parameters from(@NonNull SharedPreferences prefs, @Nullable Bundle bundle,
                                  ...
                                  String defaultRegistryId, String defaultCloudRegion,
                                  String defaultDeviceId, String defaultKeyAlgorithm) {

        Parameters params = new Parameters();
        params.projectId = prefs.getString("project_id", defaultProjectId);
        params.registryId = prefs.getString("registry_id", defaultRegistryId);
        params.cloudRegion = prefs.getString("cloud_region", defaultCloudRegion);
        params.deviceId = prefs.getString("device_id", defaultDeviceId);
        params.keyAlgorithm = prefs.getString("key_algorithm", defaultKeyAlgorithm);
        if (bundle != null) {
