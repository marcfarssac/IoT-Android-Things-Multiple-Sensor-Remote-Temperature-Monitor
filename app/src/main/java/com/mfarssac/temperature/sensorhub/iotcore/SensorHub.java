...
import com.mfarssac.temperature.sensorhub.TimerHelper;
import com.mfarssac.temperature.sensorhub.collector.EventSensorCollector;
import com.mfarssac.temperature.sensorhub.collector.SensorCollector;
...
public class SensorHub {
    ...
    private static final int DEFAULT_TELEMETRY_PER_HOUR = 60*12; // every 20 seconds
...
//                    public static final int REASON_CLIENT_CLOSED = 4;
    ...
    private void publishTelemetry(List<SensorData> currentReadings) {
        ...
        TelemetryEvent event = new TelemetryEvent(payload.getBytes(),
                "temp-reading", TelemetryEvent.QOS_AT_LEAST_ONCE);
